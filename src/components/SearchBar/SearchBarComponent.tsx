...
export default function SearchBar() {
  ...
  return (
    <div className="w-full flex flex-row-reverse items-center border rounded-full overflow-hidden bg-white lg:flex-row">
      {/* Selection Dropdown */}
      <select
        className="hidden px-4 py-3 bg-gray-100 border-r focus:outline-none lg:block"
