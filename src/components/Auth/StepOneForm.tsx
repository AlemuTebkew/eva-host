...
export const Step1 = () => {
  ...
  return (
    <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
      {/* Personal Info */}
      <Card className="p-6 transition-all  hover:translate-y-[-10px]  duration-300 hover:shadow-lg">
        ...
        <div className="space-y-5">
          <FormItem>
            ...
            />
            <FormMessage className="text-sm">{errors.firstName?.message as string}</FormMessage>
          </FormItem>
          ...
          <FormItem>
            ...
            <Input
              ...
              className="transition-all duration-200 focus:border-blue-800 focus:ring-2 focus:ring-blue-800/20"
            />
            <FormMessage className="text-sm">{errors.lastName?.message as string}</FormMessage>
          </FormItem>
          ...
          <FormItem>
            ...
            <Input
              ...
              className="transition-all duration-200 focus:border-blue-800 focus:ring-2 focus:ring-blue-800/20"
            />
            <FormMessage className="text-sm">{errors.email?.message as string}</FormMessage>
          </FormItem>
          ...
          <FormItem>
            ...
            />
            <FormMessage className="text-sm">{errors.phoneNumber?.message as string}</FormMessage>
          </FormItem>
          ...
          <FormItem>
            ...
            <Input
              ...
              className="transition-all duration-200 focus:border-blue-800 focus:ring-2 focus:ring-blue-800/20"
            />
            <FormMessage className="text-sm">{errors.password?.message as string}</FormMessage>
          </FormItem>
        </div>
      </Card>

      {/* Company & Address */}
      <Card className="p-6 transition-all duration-300 hover:shadow-md  hover:translate-y-[-10px]">
        <h3 className="mb-6 text-lg font-semibold text-gray-900">Company Information</h3>
        <div className="space-y-5">
          <FormItem>
            ...
            <Input
              ...
              className="transition-all duration-200 focus:border-blue-800 focus:ring-2 focus:ring-blue-800/20"
            />
            <FormMessage className="text-sm">{errors.companyName?.message as string}</FormMessage>
          </FormItem>

          <FormItem>
            <FormLabel className="text-sm font-medium text-gray-700">Company TIN</FormLabel>
            <Input
              {...register("companyTIN", { maxLength: 50 })}
              placeholder="Enter TIN"
              className="transition-all duration-200 focus:border-blue-800 focus:ring-2 focus:ring-blue-800/20"
            />
            <FormMessage className="text-sm">{errors.companyTIN?.message as string}</FormMessage>
          </FormItem>

          <div className="grid gap-5 md:grid-cols-2">
            <FormItem>
              <FormLabel className="text-sm font-medium text-gray-700">License Photo (optional)</FormLabel>
              <FileUploader
            ...
            <FormItem>
              <FormLabel className="text-sm font-medium text-gray-700">Company Logo (optional)</FormLabel>
              <FileUploader
          ...
          <div className="rounded-lg border border-gray-200 bg-gray-50/50 p-4 transition-all duration-300 hover:bg-gray-50">
            <h4 className="mb-4 text-sm font-medium text-gray-900">Address Information</h4>
            <div className="space-y-5">
              <RegionSelector
                onChange={(value) => {
